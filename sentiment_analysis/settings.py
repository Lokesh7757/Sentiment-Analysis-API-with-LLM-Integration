...
SECRET_KEY = 'django-insecure-r%6=bfi$2zj-@04@z1b^@i@%omssedszj4b=k4y%roat7!grcj'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,  # Ensure this is set to True to allow loading from 'templates' directories inside apps
        'OPTIONS': {
            'context_processors': [
